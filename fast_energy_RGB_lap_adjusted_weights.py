...
if __name__ == '__main__':
    ...
    output_prefix=current_folder+"Application_Files/"
    ...
    import time
    start=time.clock()
    run_one( current_folder+image_path, current_folder+OrderPath, current_folder+color_path, output_prefix, weightspath = current_folder+weightspath, save_every = save_every, solve_smaller_factor = solve_smaller_factor, too_small = too_small )
    end=time.clock()
